...
```{r}
V1Coef <- 0 #REMEMBER THESE ARE HIGHLY CORRELATED 
V2Coef <- 2 #REMEMBER THESE ARE HIGHLY CORRELATED 
V3Coef <- 2 #REMEMBER THESE ARE HIGHLY CORRELATED 
V4Coef <- 5
V5Coef <- 5
V6Coef <- 0
V7Coef <- 3
...
### Set Up
We will sample 200 different datasets from our 10,000 master data set. We will fit a linear regression 100 times and see the bias and variance of the model.
