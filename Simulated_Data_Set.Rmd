...
set.seed(1)
sigma<-rbind(c(4,0.8,0.7), c(0.8,3, 0.9), c(0.7,0.9,2))
...
#Added Some Random Noise
df <- df %>% 
  mutate(y = 5*V1 + 5*V2  +5*V4 +5*V5 +5*V6 + rnorm(1000,4,6))
```
...
full_model <- fit(full_lm_wf, data = df) 
...
penalty_grid <- grid_regular(
  penalty(range = c(-1, 1)), #log10 transformed 
  levels = 50)
...
final_fit_se <- fit(final_wf_se, data = df)
